...
@section('content')
    <div class="sorting1">
        <div class="sorting1__row">
            <h1 class="sorting1__title title ml-2">Sticker Create</h1>
        </div>
    </div>
                    ...
                    <div class="card-content">
                        <div class="px-3">
                            ...
                            <div class="login__field field m-2">
                                <button type="button"
                                    onclick="addFormData(event,'post','{{ url('admin/stickers') }}','{{ request()->q ? url('admin/companies/' . request()->q . '/edit') : url('admin/stickers') }}','add-video')"
