                                    ...
                                    <div class="tab-pane active " id="product" role="tabpanel">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label>State</label>
                                                    <select name="state_id" onchange="getCities(event,'{{url('admin/get-cities')}}')" class="form-control select2" required>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-row">
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                <label class="text-muted" for="company_location_state">Location if
                                                                    different to
                                                                    company</label>
                                                                <select class="form-control" id="company_location_state" name="company_location_state select2">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                ...
                                                                <input type="text" required="" class="form-control"
                                                                    id="company_group" name="company_group" placeholder="Group">
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                ...
                                                                <input type="text" required="" class="form-control"
                                                                    id="company_destination_url" name="company_destination_url"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-row">
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                ...
                                                                <select class="form-control select2" id="company_ftp_protocol"
                                                            ...
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                ...
                                                                <input type="text" class="form-control" id="company_ftp_host"
                                                                    name="company_ftp_host" placeholder="Host">
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 form-group col-sm-12">
                                                                <label class="text-muted"
