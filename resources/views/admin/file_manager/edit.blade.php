...
@section('content')
    <div class="sorting1">
        <div class="sorting1__row">
            <h1 class="sorting1__title title ml-2">Folder Update</h1>
        </div>
    </div>
                        ...
                        <div class="px-3">
                            <form id="add-video" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="field__input" required value="{{ $record->name }}"
                                ...
                                <div class="login__field field">
                                    ...
                                    <button type="button"
                                        onclick="addFormData(event,'post','{{ url('admin/file-managers/' . $record->id) }}','{{ url('admin/file-managers') }}','add-video')"
